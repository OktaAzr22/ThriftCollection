                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            <form method="GET" action="{{ route('brands.index') }}" 
                                ...
                                <input 
                                    class="px-10 py-2 text-sm border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 ease-in-out w-4/5 md:w-48 origin-right focus:w-full md:focus:w-64"
                                    type="text"
                                    id="searchInput"
                                    name="search"
                                ...
                                @if($brands->count() > 0)
                                    ...
                                    @foreach($brands as $brand)
                                        ...
                                        <tr class="hover:bg-slate-50">
                                            ...
                                            <td>{{ $brand->brand_origin }}</td>

                                            <td class="font-medium">{{ $brand->items_count }}</td>

                                            <td class="text-center">

                                                <div class="flex justify-center gap-2">

                                                    <button onclick="bukaModal('global-modal', '/brand/{{ $brand->id }}/items')" class="w-8 h-8 flex items-center justify-center rounded-md bg-slate-100 text-slate-600 hover:bg-slate-200 transition" title="Lihat Detail">
                                                        <i class="fa-solid fa-eye text-xs"></i>
                                                    </button>

                                                    <button title="Edit" onclick="openModal('modalEditBrand-{{ $brand->id }}')" class="w-8 h-8 flex items-center justify-center rounded-md bg-blue-50 text-blue-600 hover:bg-blue-100 transition">
                                                    ...
                                                    <button onclick="openDeleteModal(
                                                            ...
                                                            'BRAND', 
                                                            '{{ $brand->name }}'
                                                        )" class="w-8 h-8 flex items-center justify-center rounded-md bg-red-50 text-red-600 hover:bg-red-100 transition">
