<header class="bg-white dark:bg-black border-b border-slate-200 dark:border-purple-500/20 sticky top-0 z-10">
    <div class="flex items-center justify-between px-8 py-4">
        <div class="flex-1 max-w-md">
            <div class="relative">
                <svg class="w-5 h-5 text-slate-400 dark:text-purple-400 absolute left-3 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                </svg>
                <input type="text" placeholder="Cari sesuatu..." class="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-purple-500/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-purple-500/30 focus:border-blue-500 dark:focus:border-purple-500 transition dark:bg-black dark:text-white dark:placeholder-white/50">
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <button class="relative p-2 text-slate-600 dark:text-white hover:bg-slate-100 dark:hover:bg-purple-500/10 rounded-xl transition">
                ...
                <span class="absolute top-1 right-1 w-2 h-2 bg-blue-500 dark:bg-purple-500 rounded-full"></span>
            </button>
            ...
            <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-black rounded-xl shadow-lg border border-slate-200 dark:border-purple-500/30 py-2 z-50">
                <div class="px-4 py-2 hover:bg-slate-50 dark:hover:bg-purple-500/10 cursor-pointer">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm text-slate-700 dark:text-white">Mode Gelap</span>
                    </div>
                </div>
                <div class="px-4 py-2 hover:bg-slate-50 dark:hover:bg-purple-500/10 cursor-pointer">
                    <div class="flex items-center space-x-3">
                ...
                <div class="px-4 py-2 hover:bg-slate-50 dark:hover:bg-purple-500/10 cursor-pointer">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm text-slate-700 dark:text-white">Kelola Toko</span>
                    </div>
                </div>
                <div class="border-t border-slate-200 dark:border-purple-500/20 my-2"></div>
                <div class="px-4 py-2 hover:bg-red-50 dark:hover:bg-purple-500/20 cursor-pointer">
                    <div class="flex items-center space-x-3 text-red-600 dark:text-purple-400">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
