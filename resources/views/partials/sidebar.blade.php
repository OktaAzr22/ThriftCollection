<aside class="w-72 bg-white dark:bg-black border-r border-slate-200 dark:border-purple-500/20 flex flex-col">
    <div class="p-6 border-b border-slate-200 dark:border-purple-500/20">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="text-xl font-bold text-slate-800 dark:text-white">Dashboard<span class="text-blue-600 dark:text-purple-400">.</span></h1>
        </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4">
        ...
        <div class="mb-8">
            <h3 class="text-xs font-semibold text-slate-400 dark:text-white/50 uppercase tracking-wider mb-4 px-4">Main Menu</h3>
            <nav class="space-y-1">
            ...
            <nav class="space-y-1">
                ...
                <div class="ml-4">
                    <button onclick="toggleSubMenu('reportsMenu')" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-500 dark:text-white/60 hover:text-slate-700 dark:hover:text-white rounded-lg transition duration-200">
                        <span>Laporan</span>
                        <svg id="reportsMenu-icon" class="w-4 h-4 transition-transform duration-200 {{ request()->routeIs('brands.*') || request()->routeIs('master.*') || request()->routeIs('toko.*') ? 'rotate-180' : '' }} dark:text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- MANAGEMENT SECTION -->
                <div class="mb-8">
                    ...
                    <nav class="space-y-1">
                        ...
                        <div>
                            <button onclick="toggleSubMenu('userMenu')" class="w-full flex items-center justify-between px-4 py-3 text-slate-600 dark:text-white/80 hover:bg-slate-50 dark:hover:bg-purple-500/10 rounded-xl transition duration-200">
                                ...
                                <svg id="userMenu-icon" class="w-4 h-4 transition-transform duration-200 dark:text-white/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>
                            ...
                            <div id="userMenu" class="mt-2 space-y-1 overflow-hidden transition-max-height max-h-0">
                                <div class="ml-4">
                                    <h4 class="text-sm font-medium text-slate-500 dark:text-white/50 px-4 mb-2">Data Pengguna</h4>
                                    <a href="#" class="flex items-center px-4 py-2 text-sm text-slate-600 dark:text-white/70 hover:bg-slate-50 dark:hover:bg-purple-500/10 rounded-lg transition duration-200 ml-4">
